...
Options\+: -\/a, --alt-\/service-\/name=my\+\_\+service\+\_\+name {\itshape lcd\+\_\+display\+\_\+service} is default, use this to change name. -\/u, --unique-\/registry List {\itshape unique} entries from all responses. -\/m, --message Any text to send; \+\_\+\textquotesingle{}{\bfseries Q\+U\+I\+T!}\textquotesingle{} causes service to terminate.\+\_\+ \+\_\+\textquotesingle{}$\ast$$\ast$\+A\+D\+D $\ast$$\ast$$<$delimited-\/response-\/message-\/string$>$\textquotesingle{} -- add new registry entry into Service\+\_\+ -\/v, --version Version printout. -\/h, --help Show this help screen.
